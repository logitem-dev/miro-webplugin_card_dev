  ...
  miro.initialize({
    extensionPoints: {
      ...
      toolbar: {
        ...
        positionPriority: 1,
        onClick: async () => {
          if (confirm("カード変換処理を行います。よろしいですか？") === false) {
            return false;
          }

//          const client_id = "3458764516006800161";
          const clinet_id = miro.clientId();
